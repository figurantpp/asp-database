...
ALTER TABLE FUNCIONÁRIO ADD FOREIGN KEY (CÓDIGO_USUÁRIO) REFERENCES USUÁRIO (CÓDIGO);

ALTER TABLE CLIENTE ADD FOREIGN KEY (CÓDIGO_USUÁRIO) REFERENCES USUÁRIO (CÓDIGO);
